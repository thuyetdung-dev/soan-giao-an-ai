...
export type VariationVisual={type:"variation_table";x:string[];derivative:string[];values:string[];discontinuities?:{index:number;leftValue:string;rightValue:string}[]};
